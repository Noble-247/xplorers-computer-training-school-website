...
import firstCarouselImage from "../assets/carousel-img/carousel-image-1.jpg";
import secondCarouselImage from "../assets/carousel-img/carousel-image-2.jpg";
import thirdCarouselImage from "../assets/carousel-img/carousel-image-3.jpg";
import fourthCarouselImage from "../assets/carousel-img/carousel-image-4.jpg";
          ...
          <Carousel.Caption>
            <div className="carousel-caption-style">
              ...
              <div className="d-flex">
                <Link
                  to="/"
                  className="btn btn-light d-block mr-3 btn-lg"
                >
                  Read More
                </Link>
                <Link
